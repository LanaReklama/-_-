...
function art_add_admin() {
    ...
    add_theme_page("Design WP Theme Options", "Design WP Theme Options", 'edit_themes', basename(__FILE__), 'art_admin');
